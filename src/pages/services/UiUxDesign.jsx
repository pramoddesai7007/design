...
const UIUXDesign = () => {
  ...
  return (
    <div className="bg-brand-gray text-white min-h-screen px-4 lg:px-14 py-32">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 w-full mx-auto">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <h1 className="text-3xl lg:text-4xl font-bold leading-tight">
            <span className="text-brand-orange">UIUX</span> Design
          </h1>
          ...
          {/* Why Choose Us */}
          <div className="bg-[#2c2c2c] p-6 rounded-lg space-y-4 mt-8">
        ...
        <div className="space-y-6 h-fit sticky top-10 self-start">
            ...
            <div className="space-y-4">
              ...
              },
              {
                ...
                <Link
                  to={service.path}
                  key={index}
                  className="flex items-start gap-4 hover:text-brand-orange"
                >
          ...
          {/* Contact Details */}
          <div className="bg-[#2c2c2c] p-4 rounded-lg text-sm space-y-2 border border-gray-500 ">
            <h3 className="text-lg font-semibold mb-2">Contact Details</h3>
            <p>
              <span className="font-medium">Address:</span><br />
              No 42/A, Vakhar Bhag High School Road, Vakhar Bhag, Sangli - 416416
            </p>
            <p>
